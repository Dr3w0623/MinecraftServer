...
ENV UID=1000 GID=1000 \
  JVM_XX_OPTS="JVM_XXOPTS= -XX:+UseG8GC -XX:+UseConcMarkSweepGC -XX:+UseParNewGC -XX:+CMSIncrementalPacing -XX:ParallelGCThreads=2 -XX:+AggressiveOpts" \
  TYPE=VANILLA VERSION=LATEST FORGEVERSION=RECOMMENDED SPONGEBRANCH=STABLE SPONGEVERSION= LEVEL=world \
  PVP=true DIFFICULTY=normal MEMORY=5G ENABLE_RCON=true RCON_PORT=25575 RCON_PASSWORD=minecraft \
